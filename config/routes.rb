Rails.application.routes.draw do
  ...
  scope '/:locale', locale: /en|cy/ do
    ...
    resources :car_campaigns, only: 'show',
                              path: 'campaigns',
                              constraints: {
                                id: %r{revealed-the-true-cost-of-buying-a-car|edrychwch-cost-gwirioneddol-prynu-car|how-to-look-ahead-when-buying-a-car|cy-how-to-look-ahead-when-buying-a-car }
                              }
